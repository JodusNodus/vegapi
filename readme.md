...
* Create a git repository with `$ git init` and add your git user information `$ git config user.name "JodusNodus" && git config user.email "billiet.thomas@outlook.com"`
* Create a remote repository on [Github][github] with the name `vegapi`. It should look after: `https://github.com/jodusnodus/vegapi.git`
